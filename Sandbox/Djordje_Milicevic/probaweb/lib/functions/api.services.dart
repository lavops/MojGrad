...
class APIServices{
  ...
  static Future fetchUser() async{
    String userURL = 'https://localhost:44399/api/User';
  ...
  static Future register(String mail, String sifra, String korisnickoIme, String ime, String prezime) async{
    String registerURL = 'https://localhost:44399/api/User/Register';
  ...
  static Future login(String mail, String password) async{
    String loginURL = 'https://localhost:44399/api/User/Login';
  ...
  static Future history(int id, String token) async{
    String historyUrl = 'https://localhost:44399/api/History/Count/' + id.toString();
