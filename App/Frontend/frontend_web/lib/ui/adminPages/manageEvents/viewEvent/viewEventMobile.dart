      ...
      body: Container(
          ...
          child: ConstrainedBox(child: Column(children: <Widget>[
            ...
            Column(children: <Widget>[
              usersForEvent==null ? Text("Nema prijavljenih korisnika za ovaj događaj", style: TextStyle(fontSize: 12.0),) 
                : (usersForEvent.length==0 ? Text("Nema prijavljenih korisnika za ovaj događaj", style: TextStyle(fontSize: 12.0),) : Text("Broj prijavljenih korisnika: " + usersForEvent.length.toString(), style: TextStyle(fontSize: 12.0),)),
              usersForEvent!=null ? listUsers() : SizedBox(),
              institutionsForEvent==null ? Text("Nema prijavljenih institucija za ovaj događaj", style: TextStyle(fontSize: 12.0),)
                : (institutionsForEvent.length==0 ? Text("Nema prijavljenih institucija za ovaj događaj", style: TextStyle(fontSize: 12.0),) : Text("Broj prijavljenih institucija: " + institutionsForEvent.length.toString(), style: TextStyle(fontSize: 12.0),)),
