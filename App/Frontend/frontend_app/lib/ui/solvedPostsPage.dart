...
class SolvedPostsPage extends StatefulWidget {
  final User user;
  SolvedPostsPage(this.user);
  @override
  _SolvedPostsPageState createState() => _SolvedPostsPageState(user);
}
...
class _SolvedPostsPageState extends State<SolvedPostsPage> {
  ...
  _SolvedPostsPageState(User user1) {
    this.user = user1;
  }
